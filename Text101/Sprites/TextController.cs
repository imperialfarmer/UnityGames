...
public class TextController : MonoBehaviour {
	...
	private enum States {
		cell, mirror, sheets_0, lock_0, put_mirror_back, cell_mirror, sheets_1, lock_1, corridor_0, 
	...
	void Update () {
		...
		else if (myState == States.put_mirror_back) {state_put_mirror_back ();}
	...
	void state_put_mirror_back ()
	{
		text.text = "You put the Mirror back to where it was \n \n" +
					"Press \'C\' to Continue";
	...
	void cell_mirror() {
		text.text = "You are still in your cell, and you STILL want to escape! There are " +
					...
					"Press M to put back mirror";
		if 		(Input.GetKeyDown(KeyCode.S)) 	{myState = States.sheets_1;}
		else if (Input.GetKeyDown(KeyCode.L)) 	{myState = States.lock_1;}
		else if (Input.GetKeyDown(KeyCode.M)) 	{myState = States.put_mirror_back;}
    }
